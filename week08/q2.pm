...
=head2 Name:
The 'name' Attribute is the restriction enzyme's name. An example of this is "EcoRI". To change the name of your object use "$var->name() = 'new name';" or to get the name of your object use "$var->name()".
...
The "cut_dna" method is provided so you can pass into it your restriction enzyme object and a given dna sequence and it will return an array that consists of your fragments after it is cut. To use this use the function "cut_dna($RestrictionEnzymeObject, $dna_seq)".
